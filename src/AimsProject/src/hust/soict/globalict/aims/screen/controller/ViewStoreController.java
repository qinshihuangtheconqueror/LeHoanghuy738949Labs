...
public class ViewStoreController {
    ...
    void btnViewCartPressed(ActionEvent event) {
        try {
            final String CART_FXML_FILE_PATH = "/AimsProject/src/hust/soict/globalict/aims/screen/view/cart.fxml";
    ...
    public void initialize() {
        final String ITEM_FXML_FILE_PATH = "/AimsProject/src/hust/soict/globalict/aims/screen/view/Item.fxml";
        int column = 0;
        int row = 1;
